...
<template>
  ...
  <Avatar @click="toggle" role="button" v-else-if="isLoaded && user" :image="user.imageUrl"
    class="w-[2.5rem] h-[2.5rem] cursor-pointer" shape="circle" aria-haspopup="true" aria-controls="overlay_menu" />
  <Menu class="!left-auto !right-0 !top-12" append-to="header .container" ref="menuRef" id="overlay_menu"
